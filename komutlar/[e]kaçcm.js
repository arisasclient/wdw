...
if(message.author.id == "457481463294722050") return message.reply(`**Senin Malafatın  293CM ** :eggplant:`);
message.replyNoMention("Hemen Diyorum Abi 1 Saniye..").then(message => {
